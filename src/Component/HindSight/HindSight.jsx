  ...
  return (
    <section className="bg-black text-white">
      <div className="">
        ...
        >
          <div className="w-full h-full flex-row sm:flex  justify-center items-center backdrop-brightness-50 py-32 ">
            <div className="w-[50%] ">
            ...
            <div className="w-[100%] sm:w-[50%] px-10 sm:pr-20 mt-[150%] sm:mt-0 text-center sm:text-left">
              <p className="font-medium">Getting Started</p>
              <h2 className="text-6xl sm:text-7xl font-medium mt-3">
                Free hindsight
              </h2>
              <div className="text-2xl sm:text-3xl">
                ...
                <p className=" mt-8">
                  {" "}
                  We’ve got to the top and want to help next generation get
                  there too. A chat with our growth specialists will help you
                  step back, take stock, and chart your next move.
                </p>
              </div>
